...
if !exists("g:JSLintSignErrorLine")
  let g:JSLintSignErrorLine = 1
endif
...
function! s:signInit()
  if !exists('g:jslint_sign_initialised')

    highlight errorSign         guifg=#990000 guibg=NONE ctermfg=9 ctermbg=NONE
    sign define JSLintErrorSign text=!  texthl=errorSign    linehl=NONE
